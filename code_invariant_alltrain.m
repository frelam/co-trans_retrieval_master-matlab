...
%% Training
tic;
testimgPath1 = dir('H:\÷Ïª€√ÙÀ„∑® co-training\test for HOG image retrieval\Image-Retrieval-master\Dataset\All Train\*.jpg');
hstgrm = [];
fullset_image_ftr = [];
...
for num = 1:length(testimgPath1)
    ...
    full_file_name = fullfile('H:\÷Ïª€√ÙÀ„∑® co-training\test for HOG image retrieval\Image-Retrieval-master\Dataset\All Train',file_name);
